exports = async function (changeEvent) {
  ...
  try {
    ...
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "your service mail address",
        pass: "your password",
      },
    });

    let info = await transporter.sendMail({
      from: "your service mail address",
      to: adminMail,
      subject: "YesterDay Report Details!",
      attachments: [
        {
          filename: "logo.png",
          path: "https://pbs.twimg.com/media/FI-kOuKagAMAqBB?format=png&name=small",
          cid: "logo@",
        },
      ],
      html: `
  <div style=" text-align: center;" >
      ...
      <div style="margin-top: 50px;">&copy; 2021 Meta Hospital</div>
    </div>
  `,
    });
